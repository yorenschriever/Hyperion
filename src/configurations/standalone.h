...
void LoadConfiguration()
{
    ...
    Configuration.paramCalculator = []() {
        ...
        if (APCMini::getStatus(apcColumn,0)){
            ...
            Params::secondaryColour = RGB(170,0,170);
            Params::highlightColour = RGB(255,50,255);
        }
        ...
        if (APCMini::getStatus(apcColumn,2)){
            ...
            Params::highlightColour = RGB(255,255,100);
        }
        ...
        if (APCMini::getStatus(apcColumn,4)){
            ...
            Params::highlightColour = RGB(255,255,255);
        }

        if (APCMini::getStatus(apcColumn,5)){
            //White
            Params::primaryColour = RGB(255,255,255);
            Params::secondaryColour = RGB(255,255,255);
            Params::highlightColour = RGB(255,255,255);
        }

        if (APCMini::getStatus(apcColumn,6)){
            //Gay
            Params::primaryColour = RGB(Hue(millis()/100));
            Params::secondaryColour = RGB(Hue(millis()/-100));
            Params::highlightColour = RGB(Hue(millis()/100));
        }

        if (APCMini::getStatus(apcColumn,7)){
            //Gay
            Params::primaryColour = RGB(Hue(millis()/10));
            Params::secondaryColour = RGB(Hue(millis()/-10));
            Params::highlightColour = RGB(Hue(millis()/10));
        }
    };
}
...
// // Params::setParamCalculator(calcParams);
